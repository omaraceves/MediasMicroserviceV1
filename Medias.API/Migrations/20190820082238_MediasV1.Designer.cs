...
namespace Medias.API.Migrations
{
    ...
    [Migration("20190820082238_MediasV1")]
    partial class MediasV1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Medias.API.Entities.Media", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Medias.API.Entities.MediaGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Medias.API.Entities.Media", b =>
                {
                    b.HasOne("Medias.API.Entities.MediaGroup", "MediaGroup")
                        .WithMany()
